...
<ParamField path="audiences" type="list of strings" required={false} toc={true}>
  ...
  To use audiences, first tag your API elements with [`x-fern-audiences` in OpenAPI](/learn/api-definitions/openapi/extensions/audiences), then specify which audiences to include here. 
