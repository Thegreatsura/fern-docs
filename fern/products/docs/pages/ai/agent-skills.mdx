...
This [`skills`](https://www.skills.sh) command detects your agent and writes the skill to the correct location (`.claude/skills/`, `.agents/skills/`, etc.). After it's installed for your project, your agent loads it automatically whenever a task involves authoring or editing your Fern Docs.
