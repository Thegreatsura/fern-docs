...
Similar to [`<EndpointSchemaSnippet>`](/docs/writing-content/components/endpoint-schema-snippet), but accepts any type name rather than being limited to endpoint-specific schemas. Pair with [`<SchemaSnippet>`](/learn/docs/writing-content/components/schema-snippet) to display the JSON representation alongside the field breakdown.
